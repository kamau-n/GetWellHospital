...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> GETWELL Hospital </a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <form class="form-group" action="doctorsearch.php" method="post">
        ...
        <div class="col-md-2"><a href="doctors_reports.php" class="btn btn-primary">Report</a> </div>
      </div>
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <form class="form-group" action="patientsearch.php" method="post">
        ...
        <div class="col-md-2"><a href="patients_report.php" class="btn btn-primary">Report</a> </div>
      </div>
      </form>
    </div>
      ...
      <form class="form-group" action="appsearch.php" method="post">
        ...
        <div class="col-md-2"><a href="appointment_report.php" class="btn btn-primary">Report</a> </div>
      </div>
      </form>
    </div>
